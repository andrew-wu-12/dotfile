#!/usr/bin/env bash
# Publish one Common Components Change Log page to Confluence.
...
# doc is never silently clobbered.
#
# Usage: publish_page.sh <TITLE> <BODY_FILE> [PARENT_ID] [SPACE_KEY]
#   PARENT_ID  default 3515940866  ("Common Components Change Logs")
