---
name: "doc-api-spec"
description: "generate API request/response payload structures for documentation or spec writing. Use this when asked to document an API endpoint, create a payload template, or spec out request/response shapes."
---
