...
description: "create a frontend field table for Jira spec documentation. Use this when asked to document form fields, generate a field spec table, or list frontend field definitions with i18n keys and field types."
---
