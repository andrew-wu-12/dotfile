...
description: "check existing i18n keys or propose new ones for frontend text. Use this when asked to find an i18n key, suggest a reusable key, create a new i18n key, or format a translation key for frontend text."
---
